...
describe('BOOKS API TESTS', () => {
  ...
  describe('POST /api/books/add', () => {
    it('should add new book to db', async () => {
  ...
  describe('GET /api/books?q=clean code', () => {
    it('should find book by query', async () => {
  ...
  describe('PUT /api/books/update', () => {
    it('should edit selected book by _id', async () => {
      const res = await request(app)
  ...
  describe('DELETE /api/books/delete', () => {
    it('should delete selected book by _id', async () => {
      const res = await request(app)
